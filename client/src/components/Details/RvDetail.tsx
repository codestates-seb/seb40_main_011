...
const RvDetail = () => {
  ...
  const ReviewInfo = () => {
    ...
    return (
      <div className="flex items-center justify-between w-full px-5 md:px-12 ">
        <div className="flex items-center bg-white rounded-3xl dark:bg-DMThrColor p-3">
          <div>
            <img
          ...
          <div className="flex flex-col pl-2 pb-1">
            ...
            <span className="font-medium tracking-tight text-black/40 before:text-gray-300 dark:text-white">
  ...
  return (
    <>
      ...
      <HandleSpinner />
      <div className="bg-zinc-100 py-8 dark:bg-DMSubColor dark:text-white transition-all ease-in">
        <div className="flex flex-col justify-center mx-auto w-full lg:w-[64rem] px-4 ">
          <div className="w-full flex justify-between mb-4">
            <div
              className="dark:bg-DMMainColor dark:text-white grow-0 shrink-1 w-fit flex items-center h-12 pl-4 pr-4 md:pr-8 font-bold text-black/40 hover:text-black/70 duration-150 ease-in-out bg-white rounded-full hover:bg-slate-300 hover:text-slate-700"
              role="button"
              onClick={onTypeClick}
            >
            ...
            <div className="text-black/20 flex-none h-12 rounded-full flex items-center pr-5 ml-5 dark:text-white">
          ...
          <div className="bg-white dark:bg-DMForColor rounded-t-3xl py-4 md:py-8">
            <ReviewInfo />
          ...
          <div className={`flex justify-center items-center`}>
            {review.thumbnail.length === 0 ? null : (
              <div
                className={`bg-white w-full flex justify-center items-center dark:bg-DMForColor`}
              >
                <img src={`https://codetech.nworld.dev${review?.thumbnail}`} />
              </div>
            )}
          </div>
          <section className="bg-white rounded-b-3xl flex flex-col items-center px-5 md:px-12 dark:bg-DMForColor ">
        ...
        <div className="flex flex-col justify-center mx-auto w-full lg:w-[64rem] px-4 mt-4 ">
          <div className="flex flex-col items-center bg-white rounded-3xl px-5 md:px-12 dark:bg-DMMainColor">
